...
public class PagamentoReportDAO extends GenericDAO implements IPagamentoReportDAO {
	...
	public List<ConsumoModel> fetchConsumosPorContrato(String idsContratos)
		...
		List<ConsumoModel> consumos = namedParameterJdbcTemplate.query(
				env.getProperty("SELECT_CONSUMOS").replaceAll(env.getProperty("WHERE_CONSUMO_WITHOUT_FILTER_CONTRACT"),
						env.getProperty("WHERE_CONSUMO_WITH_FILTER_CONTRACT")),
	...
	@Override
	public PagamentoModel getPagamentoUltimoSaldo(Long idReport) throws SQLException, DataAccessException {

		PagamentoModel pagamento = jdbcTemplate.query(env.getProperty("GET_ULTIMO_SALDO_PAGAMENTO"),
				new Object[] { idReport }, ResultSetExtractorUtil.getPagamentoModel());
