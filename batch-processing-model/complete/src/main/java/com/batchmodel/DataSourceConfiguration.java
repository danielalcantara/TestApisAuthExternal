...
@EnableJpaRepositories(basePackages = "br.com.hubfintech.batch.liberarsaldo.repository", entityManagerFactoryRef = "emfProcessadora", transactionManagerRef = "txProcessadora")
public class DataSourceConfiguration {
	...
	@Bean
	public JdbcTemplate jdbcTemplate(@Qualifier(value = "dsSpringbatch") DataSource dataSource) {
